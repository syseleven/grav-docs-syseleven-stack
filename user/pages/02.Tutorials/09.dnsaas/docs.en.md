...
The API can also be used with [Terraform](https://registry.terraform.io/providers/terraform-provider-openstack/openstack/latest/docs/resources/dns_zone_v2), have a look at our [Terraform examples](https://github.com/syseleven/terraform-examples).
