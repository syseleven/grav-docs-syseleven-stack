...
!!! Please refer to the [official OpenStack client documentation](https://docs.openstack.org/python-openstackclient/latest/cli/command-objects/image-v2.html#image-create) for the list of the supported parameters.
