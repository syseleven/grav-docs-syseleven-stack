...
| description    | None                                 |
| email          | hostmaster@domain.example            |
...
domain.example.  IN NS ns04.cloud.syseleven.net.
domain.example.  IN NS ns02.cloud.syseleven.net.
domain.example.  IN NS ns03.cloud.syseleven.net.
domain.example.  IN NS ns01.cloud.syseleven.net.
domain.example.  IN SOA ns04.cloud.syseleven.net. hostmaster.domain.example. 1562146000 21600 3600 259200 300
www.domain.example.  IN A 123.45.67.89
```
...
```shell
$ openstack zone import create ~/domain.example.zone
+------------+--------------------------------------+
| Field      | Value                                |
+------------+--------------------------------------+
...
| id                                   | zone_id                              | created_at                 | status   | message                  |
+--------------------------------------+--------------------------------------+----------------------------+----------+--------------------------+
| 4067eae9-b3e6-4b65-bf7b-d5c039d35586 | 2e1db03e-4d9c-4116-b023-4f3a82e1f7d7 | 2019-06-24T15:48:46.000000 | COMPLETE | domain.example. imported |
+--------------------------------------+--------------------------------------+----------------------------+----------+--------------------------+
```
...
+--------------------------------------+-----------------+---------+------------+--------+--------+
| 2e1db03e-4d9c-4116-b023-4f3a82e1f7d7 | domain.example. | PRIMARY | 1562146000 | ACTIVE | NONE   |
+--------------------------------------+-----------------+---------+------------+--------+--------+
...
+--------------------------------------+---------------------+------+---------------------------------------------------------------------------------------+--------+--------+
| 3e615366-bdb6-4b05-9235-8a14b1dad046 | domain.example.     | NS   | ns03.cloud.syseleven.net.                                                             | ACTIVE | NONE   |
|                                      |                     |      | ns04.cloud.syseleven.net.                                                             |        |        |
|                                      |                     |      | ns02.cloud.syseleven.net.                                                             |        |        |
|                                      |                     |      | ns01.cloud.syseleven.net.                                                             |        |        |
| 46f77bbd-3e5f-4276-9c10-54bf003d49b3 | domain.example.     | SOA  | ns04.cloud.syseleven.net. hostmaster.domain.example. 1562146000 21600 3600 259200 300 | ACTIVE | NONE   |
| d50a2d59-424b-4919-b51e-cb0588e414ae | www.domain.example. | A    | 123.45.67.89                                                                          | ACTIVE | NONE   |
+--------------------------------------+---------------------+------+---------------------------------------------------------------------------------------+--------+--------+
```
