...
Imagine you have a Virtual Machine(VM) which has a simple website and a database on it. you have your storage as a block device in your operating system layer, like ***/dev/vdb*** and ***/dev/sdc***. You have formated your block device and mounted in specific mountpoints for your services. you can see that there are three disks, and they are mounted in specific mount points.
...
At this method, it is OK for you to stop your services for a while (It depends on many factors) and start them after migration. Here, you can see the steps to do this
...
Start services and check the fuctionality
...
#### 7. You can keep the old volumes for a while to make sure that everything works fine and then release and delete them

After you were sure about everything, it is reasonable to release the old and unused resources
