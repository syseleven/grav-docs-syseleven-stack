...
Eine Übersicht befindet sich [hier](/syseleven-stack/02.documentation/02.compute/).

### Wie benutze ich Local SSD Storage?

Für einen schnellen Start zum ausprobieren oder herumspielen lesen Sie bitte unser [Tutorial](/syseleven-stack/03.tutorials/13.local-storage/).
...
Ja, aber das ergibt selten Sinn, denn sie nutzt ja dann den Local SSD Storage nicht mehr. Es kann aber in bestimmten Fällen hilfreich sein, um Dinge einzurichten oder zu reparieren, siehe auch unsere Anleitung zur [Datenrettung](/syseleven-stack/03.tutorials/14.nova-rescue-mode).

### Kann ich Local SSD Storage in anderen Größen erhalten?

Nein. Local SSD Storage ist ausschließlich in den angegebenen [Flavors](/syseleven-stack/02.documentation/02.compute) erhältlich.
