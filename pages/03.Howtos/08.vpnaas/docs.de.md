...
* Du solltest Wissen über die Nutzung von OpenStack CLI-Tools verfügen [OpenStack CLI-Tools](../../03.Howtos/05.openstack-cli/docs.de.md).
* Environment-Variablen müssen für den API-Zugang gesetzt sein. Siehe das Beispiel [API-Access-Tutorial](../../02.Tutorials/03.api-access/docs.en.md).
